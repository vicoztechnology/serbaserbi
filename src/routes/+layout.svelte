...
<nav class="flex xx item-center inset-x-0 z-10 fixed px-3 py-3 bg-surface-light dark:bg-surface-dark top-0 text-on-surface-light dark:text-on-surface-dark">
   ...
   {/if}
    ...
    <div class="basis-1/3 text-right" >
        <button on:click={handle} class="mr-2" name="tombol-mode-gelap">
            <span >
              {#if darkMode===false}
        ...
        <button class="mr-2" name="tombol-keranjang">
        ...
        <button class="mr-2" name="tombol-pengumuman">
            <span class="relative inline-block">
...
<nav class="flex xx  {bottomstatus} py-3  text-center flex-row fixed inset-x-0 bottom-0 bg-surface-light dark:bg-surface-dark" >
    <a href="/" aria-label="halaman beranda" class="basis-1/4">
        <button name="tombol-beranda" class="bg-secondary-container-light dark:bg-secondary-container-dark py-1 px-5 rounded-full ">
            <span> 
    ...
    <a href="/chat" aria-label="halaman chating" class="basis-1/4 ">
        <button name="tombol-chating" class="bg-surface-light dark:bg-surface-dark py-1 px-5 rounded-full ">
    ...
    <a href="/saya" aria-label="halaman akun" class="basis-1/4">
        <button name="tombol-akun" class="bg-surface-light dark:bg-surface-dark py-1 px-5 rounded-full ">
            <span class="material-symbols-rounded">
