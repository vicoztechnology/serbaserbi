...
<nav class="flex xx item-center inset-x-0 z-10 fixed px-3 py-3 bg-surface-light dark:bg-surface-dark top-0 text-on-surface-light dark:text-on-surface-dark">
   ...
   <button onclick="history.back()" name="tombol-kembali">
    <span>
   ...
   {/if}
    ...
    <div class="basis-1/3 text-right" >
        <button on:click={handle} class="mr-2" id="tombol-mode-gelap">
            <span >
              {#if darkMode===false}
        ...
        <button class="mr-2" id="tombol-keranjang">
        ...
        <button class="mr-2" id="tombol-pengumuman">
            <span class="relative inline-block">
...
<nav class="flex xx  {bottomstatus} py-3  text-center flex-row fixed inset-x-0 bottom-0 bg-surface-light dark:bg-surface-dark" >
    <a href="/" aria-label="halaman beranda" class="basis-1/4">
        <button id="tombol-beranda" class="bg-secondary-container-light dark:bg-secondary-container-dark py-1 px-5 rounded-full ">
            <span> 
        ...
        <div class="text-on-surface-light dark:text-on-surface-dark font-bold">Homee</div>
    </a>
    <a href="/chat" aria-label="halaman chating" class="basis-1/4 ">
        <button id="tombol-chating" class="bg-surface-light dark:bg-surface-dark py-1 px-5 rounded-full ">
    ...
    <a href="/live" aria-label="halaman live" class="basis-1/4">
        <button id="tombol-live" class="bg-surface-light dark:bg-surface-dark  py-1 px-5 rounded-full ">
            <span class="material-symbols-rounded"> 
    ...
    <a href="/saya" aria-label="halaman akun" class="basis-1/4">
        <button id="tombol-akun" class="bg-surface-light dark:bg-surface-dark py-1 px-5 rounded-full ">
            <span class="material-symbols-rounded">
        ...
        <div class="text-on-surface dark:text-on-surface-dark">Sayak</div>
    </a>
</nav>
