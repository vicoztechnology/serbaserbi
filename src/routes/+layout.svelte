...
<nav class="flex xx  {bottomstatus} py-3  text-center flex-row fixed inset-x-0 bottom-0 bg-surface-light dark:bg-surface-dark" >
    ...
    <div class="basis-1/4">
        ...
        <div class="text-on-surface dark:text-on-surface-dark">Live</div></div>
    <div class="basis-1/4">
        <button class="bg-surface-light dark:bg-surface-dark py-1 px-5 rounded-full ">
            <span class="material-symbols-rounded">
