...
<nav class="flex xx  {bottomstatus} py-3  text-center flex-row fixed inset-x-0 bottom-0 bg-surface-light dark:bg-surface-dark" >
    ...
    <a href="/chat" aria-label="halaman chating" class="basis-1/4 ">
        <button id="btn-chating" aria-label="tombol-chating" class="bg-surface-light dark:bg-surface-dark py-1 px-5 rounded-full ">
    ...
    <a href="/live" aria-label="halaman live" class="basis-1/4">
        <button id="btn-live" aria-label="tombol live" class="bg-surface-light dark:bg-surface-dark  py-1 px-5 rounded-full ">
            <span class="material-symbols-rounded"> 
    ...
    <a href="/saya" aria-label="halaman akun" class="basis-1/4">
        <button id="btn-akun" aria-label="tombol akun" class="bg-surface-light dark:bg-surface-dark py-1 px-5 rounded-full ">
            <span class="material-symbols-rounded">
