<script>
    ...
    let harga = 26000;
    let jumlah_harga;
    jumlah_harga = (harga * jmlbarang).toLocaleString('id-ID');
...
<PageTransition>
    <div class="detail  bg-background-light dark:bg-background-dark text-on-background-lightdark:text-on-background-dark transition-colors duration-1000" > 
        <div class="pt-16 pl-2 pr-2">
         ...
         <div class="variant pt-1 pl-4">Variant : <b>MERAH MUDA</b></div>
         <div class="mt-3 pl-3">
      ...
      <div class="flex mt-3 pl-4 pr-4">
        ...
        <div class="basis-1/2 text-right  ">
            <button class="mr-2">
                <span class=""><svg class="fill-on-background-light dark:fill-on-background-dark transition-colors duration-1000" xmlns="http://www.w3.org/2000/svg" height="24" width="24"><path d="M12 15.575q-.2 0-.375-.063-.175-.062-.325-.212l-3.6-3.6q-.275-.275-.275-.7 0-.425.275-.7.275-.275.712-.288.438-.012.713.263L11 12.15V5q0-.425.288-.713Q11.575 4 12 4t.713.287Q13 4.575 13 5v7.15l1.875-1.875q.275-.275.713-.263.437.013.712.288.275.275.275.7 0 .425-.275.7l-3.6 3.6q-.15.15-.325.212-.175.063-.375.063ZM6 20q-.825 0-1.412-.587Q4 18.825 4 18v-2q0-.425.287-.713Q4.575 15 5 15t.713.287Q6 15.575 6 16v2h12v-2q0-.425.288-.713Q18.575 15 19 15t.712.287Q20 15.575 20 16v2q0 .825-.587 1.413Q18.825 20 18 20Z"/></svg></span>
  
            </button>
            <button class="">
                <span class="">
                  <svg class="fill-primary-light dark:fill-primary-dark transition-colors duration-1000" xmlns="http://www.w3.org/2000/svg" height="20" width="20"><path d="m8.833 16.438-1.291-1.167q-2.334-2.104-4.104-4.083-1.771-1.98-1.771-4.376 0-1.958 1.323-3.291 1.322-1.333 3.302-1.333 1.125 0 2.083.468.958.469 1.625 1.198.646-.729 1.604-1.198.958-.468 2.084-.468 1.979 0 3.312 1.333 1.333 1.333 1.333 3.291 0 2.396-1.802 4.396t-4.26 4.23l-1.104 1q-.479.458-1.157.447-.677-.01-1.177-.447Z"/></svg>
                </span>
            </button>
        </div>
      </div>
      <div class="pr-4 pl-4 text-xl font-bold harga dark:text-error-dark text-error-light transition-colors duration-1000">Rp. 16.000</div>
      <div class="pr-4 pl-4 line-through font-bold harga dark:text-on-surface-variant-dark text-on-surface-variant-light transition-colors duration-1000">Rp. 26.000</div>
      <div class="rating mt-2 pr-4 pl-4 flex">
          <div class="star flex items-center ">
              <span><svg class="fill-primary-light dark:fill-primary-dark transition-colors duration-1000" xmlns="http://www.w3.org/2000/svg" height="20" width="20"><path d="m8.833 16.438-1.291-1.167q-2.334-2.104-4.104-4.083-1.771-1.98-1.771-4.376 0-1.958 1.323-3.291 1.322-1.333 3.302-1.333 1.125 0 2.083.468.958.469 1.625 1.198.646-.729 1.604-1.198.958-.468 2.084-.468 1.979 0 3.312 1.333 1.333 1.333 1.333 3.291 0 2.396-1.802 4.396t-4.26 4.23l-1.104 1q-.479.458-1.157.447-.677-.01-1.177-.447Z"/></svg> </span>
                  <span class="text-on-surface-light dark:text-on-surface-dark transition-colors duration-1000 pl-1">98.</span>&nbsp;&nbsp; Terjual (20)
          </div>

      </div>
      <div class="pb-20 mt-2 ml-2 mr-2 rounded-xl p-2 deskripsi bg-surface-light dark:bg-surface-dark text-on-surface-light dark:text-on-surface-dark transition-colors duration-1000">
      ...
      <div class="pl-2 pt-2 pb-2 pr-2 xx bg-surface-light dark:bg-surface-dark flex flex-row fixed bottom-0  inset-x-0 z-30">
          <div class="basis-1/4 text-center">
              <a href="/chat" type="button" class=" transition-colors duration-1000 border-outline-light dark:border-outline-dark border  bg-background-light dark:bg-background-dark font-medium rounded-2xl text-sm px-5 py-2.5 text-center inline-flex items-center  mr-2 mb-2">
          ...
          <div class="basis-1/4 text-center">
              <button on:click="{() => showModal = true}" type="button" class=" transition-colors duration-1000 text-on-tertiary-container-light dark:text-on-tertiary-container-dark bg-tertiary-container-light dark:bg-tertiary-container-dark font-medium rounded-2xl text-sm px-5 py-2.5 text-center inline-flex items-center  mr-2 mb-2">
          ...
          <div class="basis-2/4 text-center">
              <button type="button" class=" transition-colors duration-1000 text-on-primary-light dark:text-on-primary-dark bg-primary-light dark:bg-primary-dark font-bold rounded-full text-sm px-5 py-3 text-center inline-flex items-center ">
  ...
  <hr class="mt-3 border-outline-light dark:border-outline-dark mb-2">
    <div class="flex">
        <div class="harga basis-1/2">
          <div class="harga text-base dark:text-error-dark text-error-light transition-colors duration-1000">Rp.&nbsp;{jumlah_harga}</div>
        ...
        <div class="tombol-tambah basis-1/2 flex items-center ">
          <button on:click={kurangbrg} class="mr-2 border rounded-lg border-outline-light dark:border-outline-dark p-1"><svg class="fill-on-surface-light dark:fill-on-surface-dark transition-colors duration-1000" xmlns="http://www.w3.org/2000/svg" height="20" width="20"><path d="M5.146 10.771q-.334 0-.584-.25-.25-.25-.25-.583 0-.313.25-.563.25-.25.584-.25h9.729q.313 0 .563.25.25.25.25.563 0 .333-.25.583-.25.25-.563.25Z"/></svg></button>
          <span class="text-base mr-2">{jmlbarang}</span>
          <button on:click={tambahbrg} class="border rounded-lg border-outline-light dark:border-outline-dark p-1"><svg class="fill-on-surface-light dark:fill-on-surface-dark transition-colors duration-1000" xmlns="http://www.w3.org/2000/svg" height="20" width="20"><path d="M10 15.833q-.354 0-.615-.26-.26-.261-.26-.615v-4.083H5.042q-.354 0-.615-.26-.26-.261-.26-.615t.26-.615q.261-.26.615-.26h4.083V5.042q0-.354.26-.615.261-.26.615-.26t.615.26q.26.261.26.615v4.083h4.083q.354 0 .615.26.26.261.26.615t-.26.615q-.261.26-.615.26h-4.083v4.083q0 .354-.26.615-.261.26-.615.26Z"/></svg></button>
        </div>
      </div>
